...
#%% define event date
event_date = datetime.datetime(2022, 3, 9)
#%% Nov 11, 2023 get union of by reply, retweet, likes, tweets  #260 users
Mariupol_hospital_data, Mariupol_hospital_author_data= get_author_union('/Users/xzhao17/Documents/GitHub/timevarying/', event_date, 1, 7, 200)
#%%
Mariupol_hospital_data
#%%
Mariupol_hospital_author_data
#%%
Mariupol_hospital_author_data.num_tweets.sort_values().to_string()
